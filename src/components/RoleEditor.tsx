    ...
    >
      <div className="bg-gray-800 rounded-xl max-w-lg w-full max-h-[90vh] overflow-hidden border border-gray-700 flex flex-col">
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          {/* プリセットロールラベル */}
          <div className="px-4 pt-2 pb-1 shrink-0 border-t border-gray-700">
            <div className="text-xs text-gray-500 flex items-center justify-between">
              <span>プリセットロール</span>
    ...
    >
      <div className="flex items-start justify-between">
        <div className="flex-1 min-w-0">
          ...
          {/* 選択時に詳細表示 */}
          {isSelected && (
            <div className="mt-2 pt-2 border-t border-purple-500/30 space-y-2">
              ...
              <div className="flex gap-2 pt-1">
                <button
                  ...
                  className="flex-1 px-3 py-1.5 text-xs bg-purple-600 hover:bg-purple-500 text-white rounded transition-colors"
                >
                  編集
                </button>
                <button
